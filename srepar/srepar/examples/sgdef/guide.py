...
# ----------
# Guide with default reparameterization.
# ----------
def main(x):
    # init params
    alpha_init = 0.5
...
# """        
# # ----------
# # Guide with some non-reparameterization (via NrGamma).
# # ----------
# class NrGamma(Gamma):
#     has_rsample = False
...
#         alpha_w_q = softplus(alpha_w_q)
#         mean_w_q  = softplus(mean_w_q)
#         pyro.sample("w_bottom", NrGamma(alpha_w_q, alpha_w_q / mean_w_q))
#         #============ sample_ws
...
#         alpha_z_q = softplus(alpha_z_q)
#         mean_z_q  = softplus(mean_z_q)
#         pyro.sample("z_bottom", NrGamma(alpha_z_q, alpha_z_q / mean_z_q).to_event(1))
#         #============ sample_zs
# """
