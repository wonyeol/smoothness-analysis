"""
Source: https://github.com/pyro-ppl/pyro/tree/dev/examples/scanvi (retrieved on 2021.10.14.)
...
class SCANVI(nn.Module):
    def __init__(
        ...
        print(f'SCANVI:')
        print(f'  self.num_genes={self.num_genes}')
        print(f'  self.num_labels={self.num_labels}')
        print(f'  self.latent_dim={self.latent_dim}')
        print(f'  self.l_loc={self.l_loc}')
        print(f'  self.l_scale={self.l_scale}')
