 ...
 **
 ** ir_sig.ml: signature of the intermediate representation syntax tree
...
type dist_kind =
  ...
  (* new *)
  | LogNormal     (* see: scanvi, dpmm *)
  | ZeroInflatedNegativeBinomial (* see: scanvi *)
  | Multinomial   (* see: prodlda *)
  | VonMises      (* see: mhmm *)
  | MaskedMixtureGammaDelta (* see: mhmm *)
  | MaskedMixtureBetaDelta  (* see: mhmm *)
...
type acmd  =
  ...
  | Sample   of idtf (* trgt *) * expr (* name *) * dist (* d *)
        ...
        * bool        (* whether it was reparameterised *)
